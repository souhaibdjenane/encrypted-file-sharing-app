...
const featureCards = [
  {
    ...
    description: 'Files are encrypted with AES-256-GCM directly in your browser before upload. Your encryption keys never leave your device.',
    color: 'primary',
  },
  {
    icon: 'M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z',
    title: 'Secure Sharing',
    description: 'Generate time-limited share links. Recipients decrypt files locally with the shared key.',
    color: 'secondary',
  },
  {
    icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
    title: 'Zero-Knowledge Architecture',
    description: 'Our servers store only encrypted blobs. No metadata logging, no access to plaintext — your privacy is mathematically guaranteed.',
    color: 'accent',
  },
]

const stats = [
  { label: 'AES-256-GCM', icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z' },
  { label: 'Zero-Knowledge', icon: 'M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21' },
  { label: '100% Client-Side', icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
]
        ...
        >
          ...
          >
            <div className="absolute inset-0 animate-shimmer"
              style={{ background: 'linear-gradient(90deg, transparent, rgba(0,125,255,0.1), transparent)' }} />
            ...
            <span className="relative z-10 font-medium">End-to-end encrypted</span>
          </div>
        ...
        <div className="mt-20 sm:mt-28 grid sm:grid-cols-3 gap-5 sm:gap-6">
          {featureCards.map((card, i) => (
            <motion.div
              ...
              style={{ '--card-color': colorMap[card.color] } as React.CSSProperties}
            >
              <div
                className="w-11 h-11 flex items-center justify-center rounded-xl mb-5 transition-all duration-300 group-hover:shadow-lg"
                style={{
                  background: `color-mix(in srgb, ${colorMap[card.color]}, transparent 88%)`,
