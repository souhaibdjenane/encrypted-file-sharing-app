    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          ...
          {files && files.length > 0 && (
            ...
            >
              ...
              {files.length} file{files.length !== 1 ? 's' : ''} encrypted
            </div>
          )}
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xs font-semibold text-zinc-500 uppercase tracking-widest">Upload</h2>
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <div className="h-px flex-1 bg-gradient-to-r from-brand-primary/30 to-transparent" />
          <h2 className="text-xs font-semibold text-zinc-500 uppercase tracking-widest">Your Files</h2>
          <div className="h-px flex-1 bg-gradient-to-l from-brand-primary/30 to-transparent" />
        </div>
        <FileList />
      </motion.div>
