    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-24 sm:py-32 lg:py-40">
        ...
        <div className="mt-24 sm:mt-32 grid sm:grid-cols-3 gap-6">
          ...
          <div className="card group hover:border-brand-secondary/30 transition-colors duration-300">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-brand-secondary/10 text-brand-secondary mb-4 group-hover:bg-brand-secondary/20 transition-colors duration-300">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <p className="text-sm text-zinc-400 leading-relaxed">
              Generate time-limited share links. Recipients decrypt files locally with the shared key.
            </p>
          </div>

          <div className="card group hover:border-brand-accent/30 transition-colors duration-300">
            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-brand-accent/10 text-brand-accent mb-4 group-hover:bg-brand-accent/20 transition-colors duration-300">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
