    ...
    <div className="card">
      ...
      <div
        ...
        style={isDragOver ? {
          ...
          boxShadow: 'inset 0 0 30px rgba(0,125,255,0.05)',
        } : {}}
      >
        <input
          ref={inputRef}
        ...
        <div className="flex flex-col items-center gap-3">
          <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-300 ${
            ...
            style={{
              background: isDragOver ? 'rgba(0,125,255,0.15)' : 'rgba(39,39,42,0.6)',
              border: `1px solid ${isDragOver ? 'rgba(0,125,255,0.3)' : 'rgba(63,63,70,0.4)'}`,
            }}
          >
          ...
          <div>
            ...
            <p className="text-zinc-500 text-xs sm:text-sm mt-1">Files are end-to-end encrypted before upload</p>
          </div>
        </div>
      </div>
